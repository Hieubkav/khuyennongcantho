                  ...
                  >
                    ...
                    <td className="py-2 pr-0">
                      <div className="flex justify-end gap-2">
                        ...
                        <UnitDeleteButton id={u._id as any} name={u.name} onDelete={() => onDelete(u._id as any, u.name)} />
                        <Button size="sm" variant="outline" asChild>
                          <Link href={`/dashboard/units/${u._id}/edit`}>
                            <Edit className="mr-2 h-4 w-4" /> Sửa
                          </Link>
                        </Button>
                        <Button size="sm" variant="destructive" onClick={() => onDelete(u._id as any, u.name)} className="hidden">
